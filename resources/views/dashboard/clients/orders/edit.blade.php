                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody class="order-list">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number"   name="products[{{$product->id}}][quantity]" data-price="{{number_format($product->sale_price, 2)}}" class="form-control input-sm product-quanitity" min="1" value="{{$product->pivot->quantity}}"> </td>
                                ...
                                <button class="btn btn-primary btn-block" id="form-btn"><i class="fa fa-plus"></i> @lang('site.add_order')</button>
